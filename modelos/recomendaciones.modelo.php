...
class ModeloRecomendaciones{
	...
	REGISTRO DE ANEXOS
	=============================================*/
	static public function mdlRegistroRecomendacion($tabla, $datos){
	...
	MOSTRAR ANEXOS
	=============================================*/
	static public function mdlMostrarRecomendaciones($tabla, $item, $valor){
		if($item != null){
	...
	ACTUALIZAR ANEXOS
	=============================================*/
	static public function mdlActualizarRecomendacion($tabla, $item1, $valor1, $item2, $valor2){
	...
	EDITAR ANEXO
	=============================================*/
	static public function mdlEditarRecomendacion($tabla, $datos){	
	...
	BORRAR ANEXO
	=============================================*/
	static public function mdlBorrarRecomendacion($tabla, $datos){
